...
scalF          = 5.0;   % scaling factor for gauss quadrature...
k              = 0.1;   % spatial wave number...
...
% -- Scaling of the polynomial to get more points in the BL..ives...
transLaguerreFunc = makeTransformedLaguerreFunc(laguerreFunc);
...
plotBaseVelProfiles(0:0.001:2,3);

% Orr-Sommerfeld Operator (linear base profile)...
linearSol = orrSommerfeldOperator ( k,Re,...
    linearBaseVelocity(:,1),linearBaseVelocity(:,2),laguerreGQWeights,...
    transLaguerreFunc,transLaguerreFunc1,transLaguerreFunc2 );

% Orr-Sommerfeld Operator (parabolic base profile)...
parabolicSol = orrSommerfeldOperator ( k,Re,...
